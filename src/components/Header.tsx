  ...
  return (
    <div className="space-y-8 mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card-gradient rounded-xl p-6 space-y-2">
      ...
      {/* Navigation Bar */}
      <header className="w-full flex justify-between items-center px-4 py-2 bg-secondary/50 rounded-lg backdrop-blur-sm">
