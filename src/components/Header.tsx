        ...
        <CardContent className="pt-12 pb-14 px-8">
          ...
          <div className="flex flex-col items-center space-y-10">            
            <div className="text-center space-y-6">
              ...
              <p className="text-cyan-400 animate-fade-in delay-100 font-medium text-xl py-0">by EngageAI</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mt-4">
              <div className="flex items-center gap-4 p-6 rounded-2xl bg-black/50 backdrop-blur-xl border border-cyan-500/30 shadow-lg hover:shadow-xl transition-all duration-500 group hover:bg-black/60">
                <Bot className="w-12 h-12 text-cyan-400 group-hover:scale-110 transition-transform duration-500" style={{
              ...
              <div className="flex items-center gap-4 p-6 rounded-2xl bg-black/50 backdrop-blur-xl border border-cyan-500/30 shadow-lg hover:shadow-xl transition-all duration-500 group hover:bg-black/60">
                <Search className="w-12 h-12 text-cyan-400 group-hover:scale-110 transition-transform duration-500" style={{
                filter: 'drop-shadow(0 0 10px rgba(6, 182, 212, 0.5))'
              }} />
                <div>
              ...
              <div className="flex items-center gap-4 p-6 rounded-2xl bg-black/50 backdrop-blur-xl border border-cyan-500/30 shadow-lg hover:shadow-xl transition-all duration-500 group hover:bg-black/60">
                <BarChart3 className="w-12 h-12 text-cyan-400 group-hover:scale-110 transition-transform duration-500" style={{
                filter: 'drop-shadow(0 0 10px rgba(6, 182, 212, 0.5))'
              }} />
                <div>
